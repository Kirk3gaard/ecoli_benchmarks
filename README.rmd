...
```{r sort_byfig.height=figH,fig.width=16, warning=FALSE,echo=FALSE,message=FALSE}
...
## Aim
To test whether there is an assembly+polishing strategy that can remove the need for polishing with short reads.
